...
public class MainJavaFX_Checkbox extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        button.setOnAction(e -> {
            ...
            if (box1.isSelected()) message += " " + box1.getText();
            if (box2.isSelected()) message += " " + box2.getText();
            if (box3.isSelected()) message += " " + box3.getText();
